...
!(function(t, i) {
  ...
  function r(t) {
    if (!t._start)
      try {
        ...
        if (t._tasks[t._ended + t._active - 1]) e(t, i);
  ...
  function a(t, i) {
    return function(n, a) {
      t._tasks[i] &&
        ...
        (t._tasks[i] = null),
        null == t._error &&
          (null != n ? e(t, n) : ((t._data[i] = a), t._waiting ? r(t) : o(t))));
    };
  }
  function e(t, i) {
    var r,
      n = t._tasks.length;
    for (t._error = i, t._data = void 0, t._waiting = NaN; --n >= 0; )
      if ((r = t._tasks[n]) && ((t._tasks[n] = null), r.abort))
        try {
          r.abort();
        } catch (i) {}
    (t._active = NaN), o(t);
  ...
  (i.prototype = s.prototype = {
    ...
    defer: function(t) {
      ...
      return i.push(t), ++this._waiting, this._tasks.push(i), r(this), this;
    },
    abort: function() {
      return null == this._error && e(this, new Error("abort")), this;
    },
    await: function(t) {
      if ("function" != typeof t) throw new Error("invalid callback");
      if (this._call) throw new Error("multiple await");
      return (
        (this._call = function(i, r) {
